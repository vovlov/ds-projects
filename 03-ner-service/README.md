...
| Тест | Rule-based | BERT NER (Docker) |
|------|-----------|-------------------|
| "Владимир Путин посетил Москву" | PER + LOC | B-PER, I-PER, O, B-LOC, O |
| "Газпром в Санкт-Петербурге" | ORG + LOC | B-ORG, O, B-LOC |
| "Сбербанк в Москве" | ORG + LOC | — |

Rule-based: высокая precision на известных сущностях, но не ловит новые имена.
BERT: обобщает на unseen entities (обучен на 15 примерах, 20 эпох).
